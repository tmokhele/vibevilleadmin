...
export class DashboardComponent implements OnInit {
  ...
  public registrationRequests$: Observable<AuthData[]>;
  constructor(public venue: VenueService, public userservice: UserService, public router: Router) {
  ...
  ngOnInit() {
    ...
    this.registrationRequests$ = this.userservice.getRegistrationRequests();
